...
var __copyProps = (to, from, except, desc) => {
	if (from && typeof from === "object" || typeof from === "function") {
		for (var keys = __getOwnPropNames(from), i$1 = 0, n$2 = keys.length, key; i$1 < n$2; i$1++) {
			key = keys[i$1];
...
//#endregion
//#region ../../node_modules/.pnpm/gunshi@0.26.3/node_modules/gunshi/lib/utils-D41C8Abf.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/gunshi@0.26.3/node_modules/gunshi/lib/context-D_EmfRNA.js
var en_US_default = {
	COMMAND: "COMMAND",
	COMMANDS: "COMMANDS",
...
//#endregion
//#region ../../node_modules/.pnpm/gunshi@0.26.3/node_modules/gunshi/lib/definition-wq1Kmbvq.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/gunshi@0.26.3/node_modules/gunshi/lib/renderer-BzRfaLdJ.js
/**
* Render the header.
...
//#endregion
//#region ../../node_modules/.pnpm/gunshi@0.26.3/node_modules/gunshi/lib/cli-DVGNVw3h.js
/**
* Run the command.
* @param args Command line arguments
...
var require_emoji_regex$1 = /* @__PURE__ */ __commonJS({ "../../node_modules/.pnpm/emoji-regex@8.0.0/node_modules/emoji-regex/index.js": ((exports, module) => {
...
var require_utils$1 = /* @__PURE__ */ __commonJS({ "../../node_modules/.pnpm/cli-table3@0.6.5/node_modules/cli-table3/src/utils.js": ((exports, module) => {
...
//#endregion
//#region ../../node_modules/.pnpm/cli-table3@0.6.5/node_modules/cli-table3/src/layout-manager.js
var require_layout_manager = /* @__PURE__ */ __commonJS({ "../../node_modules/.pnpm/cli-table3@0.6.5/node_modules/cli-table3/src/layout-manager.js": ((exports, module) => {
...
//#endregion
//#region ../../node_modules/.pnpm/cli-table3@0.6.5/node_modules/cli-table3/src/table.js
var require_table = /* @__PURE__ */ __commonJS({ "../../node_modules/.pnpm/cli-table3@0.6.5/node_modules/cli-table3/src/table.js": ((exports, module) => {
...
//#endregion
//#region ../../node_modules/.pnpm/cli-table3@0.6.5/node_modules/cli-table3/index.js
var require_cli_table3 = /* @__PURE__ */ __commonJS({ "../../node_modules/.pnpm/cli-table3@0.6.5/node_modules/cli-table3/index.js": ((exports, module) => {
	module.exports = require_table();
}) });

//#endregion
//#region ../../node_modules/.pnpm/es-toolkit@1.39.10/node_modules/es-toolkit/dist/array/uniq.mjs
function uniq(arr) {
...
//#endregion
//#region ../../node_modules/.pnpm/emoji-regex@10.5.0/node_modules/emoji-regex/index.js
var require_emoji_regex = /* @__PURE__ */ __commonJS({ "../../node_modules/.pnpm/emoji-regex@10.5.0/node_modules/emoji-regex/index.js": ((exports, module) => {
	module.exports = () => {
...
if (import.meta.vitest != null) {
	describe("ResponsiveTable", () => {
		describe("compact mode behavior", () => {
			it("should activate compact mode when terminal width is below threshold", () => {
				...
				const originalColumns = process$1.env.COLUMNS;
				process$1.env.COLUMNS = "80";
				table.push([
					"2024-01-01",
					"sonnet-4",
					"1000",
				...
				process$1.env.COLUMNS = originalColumns;
			});
		...
		describe("getCurrentTableConfig", () => {
			it("should return compact config when in compact mode", () => {
				...
				table.toString();
				const config = table.getCurrentTableConfig();
				expect(config.head).toEqual([
					"Date",
					"Model",
					"Cost"
				]);
				expect(config.colAligns).toEqual([
					"left",
					"left",
					"right"
				]);
		...
		describe("getCompactIndices", () => {
			it("should return correct indices for existing compact headers", () => {
				...
				table.toString();
				const indices = table.getCompactIndices();
			...
			it("should fallback to first column for non-existent headers and log warning", () => {
				...
				expect(mockLogger).toHaveBeenCalledWith("Warning: Compact header \"NonExistent\" not found in table headers [Date, Model, Input, Output, Cost]. Using first column as fallback.");
				process$1.env.COLUMNS = originalColumns;
			});
			...
			it("should return all indices when compactHead is null", () => {
				const indices = new ResponsiveTable({
					head: [
						"Date",
						"Model",
						"Input",
		...
		describe("toString with mocked terminal widths", () => {
			...
			it("should handle process.stdout.columns fallback when COLUMNS env var is not set", () => {
				...
				const originalColumns = process$1.env.COLUMNS;
				const originalStdoutColumns = process$1.stdout.columns;
				process$1.env.COLUMNS = void 0;
				process$1.stdout.columns = 80;
				table.push([
					"2024-01-01",
					"sonnet-4",
					"1000",
				...
				expect(table.isCompactMode()).toBe(true);
				process$1.env.COLUMNS = originalColumns;
				process$1.stdout.columns = originalStdoutColumns;
			});
			it("should use default width when both COLUMNS and process.stdout.columns are unavailable", () => {
				...
				const originalStdoutColumns = process$1.stdout.columns;
				process$1.env.COLUMNS = void 0;
				process$1.stdout.columns = void 0;
				table.push([
					"2024-01-01",
					"sonnet-4",
					"1000",
	...
	describe("formatNumber", () => {
		...
		it("formats decimal numbers", () => {
			...
			expect(formatNumber(.123)).toBe("0.123");
		});
	...
	describe("formatCurrency", () => {
		...
		it("rounds to two decimal places", () => {
			...
			expect(formatCurrency(10.995)).toBe("$10.99");
		});
		it("handles small decimal values", () => {
			expect(formatCurrency(.01)).toBe("$0.01");
			expect(formatCurrency(.001)).toBe("$0.00");
			expect(formatCurrency(.009)).toBe("$0.01");
		});
	...
	describe("formatModelsDisplayMultiline", () => {
		...
		it("formats multiple models with newlines and bullet points", () => {
			expect(formatModelsDisplayMultiline(["claude-sonnet-4-20250514", "claude-opus-4-20250514"])).toBe("- opus-4\n- sonnet-4");
		});
		...
		it("handles models that do not match pattern with bullet points", () => {
			expect(formatModelsDisplayMultiline(["custom-model", "claude-sonnet-4-20250514"])).toBe("- custom-model\n- sonnet-4");
		});
...
//#endregion
//#region ../../node_modules/.pnpm/@praha+byethrow@0.6.3/node_modules/@praha/byethrow/dist/esm/functions/is-failure.js
const isFailure = (result) => "Failure" === result.type;

//#endregion
//#region ../../node_modules/.pnpm/@praha+byethrow@0.6.3/node_modules/@praha/byethrow/dist/esm/internals/helpers/is-promise.js
...
//#endregion
//#region ../../node_modules/.pnpm/@praha+byethrow@0.6.3/node_modules/@praha/byethrow/dist/esm/functions/and-then.js
...
//#endregion
//#region ../../node_modules/.pnpm/@praha+byethrow@0.6.3/node_modules/@praha/byethrow/dist/esm/functions/and-through.js
...
//#endregion
//#region ../../node_modules/.pnpm/@praha+byethrow@0.6.3/node_modules/@praha/byethrow/dist/esm/functions/is-success.js
const isSuccess = (result) => "Success" === result.type;

//#endregion
//#region ../../node_modules/.pnpm/@praha+byethrow@0.6.3/node_modules/@praha/byethrow/dist/esm/functions/succeed.js
const succeed = (...args) => {
...
//#endregion
//#region ../../node_modules/.pnpm/@praha+byethrow@0.6.3/node_modules/@praha/byethrow/dist/esm/functions/fail.js
const fail = (...args) => {
...
//#endregion
//#region ../../node_modules/.pnpm/@praha+byethrow@0.6.3/node_modules/@praha/byethrow/dist/esm/functions/inspect.js
...
//#endregion
//#region ../../node_modules/.pnpm/@praha+byethrow@0.6.3/node_modules/@praha/byethrow/dist/esm/functions/inspect-error.js
...
//#endregion
//#region ../../node_modules/.pnpm/@praha+byethrow@0.6.3/node_modules/@praha/byethrow/dist/esm/functions/is-result.js
...
//#endregion
//#region ../../node_modules/.pnpm/@praha+byethrow@0.6.3/node_modules/@praha/byethrow/dist/esm/functions/map.js
const map = (fn) => (result) => {
	const apply = (r$1) => {
		if (isFailure(r$1)) return r$1;
...
//#endregion
//#region ../../node_modules/.pnpm/@praha+byethrow@0.6.3/node_modules/@praha/byethrow/dist/esm/functions/or-else.js
...
//#endregion
//#region ../../node_modules/.pnpm/@praha+byethrow@0.6.3/node_modules/@praha/byethrow/dist/esm/functions/pipe.js
...
//#endregion
//#region ../../node_modules/.pnpm/@praha+byethrow@0.6.3/node_modules/@praha/byethrow/dist/esm/functions/try.js
const try_ = (options) => {
...
//#endregion
//#region ../../node_modules/.pnpm/@praha+byethrow@0.6.3/node_modules/@praha/byethrow/dist/esm/functions/unwrap.js
const unwrap = (...args) => {
...
//#endregion
//#region ../../node_modules/.pnpm/fs-fixture@2.8.1/node_modules/fs-fixture/dist/index.mjs
...
const v = b.realpathSync(F.tmpdir()), D$1 = `fs-fixture-${Date.now()}-${process.pid}`;
let m = 0;
...
const w = n$1((s$1, t$1, r$1) => {
	...
	return i$1;
}, "flattenFileTree"), k = n$1(async (s$1, t$1) => {
...
function getCrawler(patterns, inputOptions = {}) {
	...
	const fdirOptions = {
		filters: [options.debug ? (p$1, isDirectory$1) => {
			const path$1$1 = format(p$1, isDirectory$1);
...
*/
const AMP_DATA_DIR_ENV = "AMP_DATA_DIR";
/**
...
*/
const DEFAULT_AMP_DIR = path.join(USER_HOME_DIR, DEFAULT_AMP_PATH);
/**
* Amp threads subdirectory name
*/
const AMP_THREADS_DIR_NAME = "threads";
/**
* Glob pattern for Amp thread files
*/
const AMP_THREAD_GLOB = "**/*.json";
/**
...
//#endregion
//#region ../../packages/internal/src/logger.ts
...
const logger = createLogger$1("@ccusage/amp");
...
function _usingCtx() {
	var r$1 = "function" == typeof SuppressedError ? SuppressedError : function(r$2, e$1) {
		var n$3 = Error();
		return n$3.name = "SuppressedError", n$3.error = r$2, n$3.suppressed = e$1, n$3;
	}, e = {}, n$2 = [];
	...
	return {
		...
		d: function d$1() {
			...
			function next() {
				for (; o$1 = n$2.pop();) try {
					if (!o$1.a && 1 === s$1) return s$1 = 0, n$2.push(o$1), Promise.resolve().then(next);
					if (o$1.d) {
			...
			function err(n$3) {
				return t$1 = t$1 !== e ? new r$1(n$3, t$1) : n$3, next();
			}
			return next();
		}
	};
...
*/
const usageLedgerEventSchema = object({
	id: string(),
	timestamp: string(),
	model: string(),
	credits: number(),
	...
	fromMessageId: optional(number()),
	toMessageId: optional(number())
});
/**
* Amp message usage schema (for cache tokens)
*/
const messageUsageSchema = object({
	model: optional(string()),
	inputTokens: optional(number()),
	outputTokens: optional(number()),
	cacheCreationInputTokens: optional(number()),
	cacheReadInputTokens: optional(number()),
...
const messageSchema = object({
	role: string(),
	messageId: number(),
	usage: optional(messageUsageSchema)
});
/**
...
const threadSchema = object({
	...
	messages: optional(array(messageSchema)),
	usageLedger: optional(object({ events: optional(array(usageLedgerEventSchema)) }))
});
/**
...
*/
function getAmpPath() {
	const envPath = process$1.env[AMP_DATA_DIR_ENV];
	if (envPath != null && envPath.trim() !== "") {
		const normalizedPath = path.resolve(envPath);
		if (isDirectorySync(normalizedPath)) return normalizedPath;
	}
	if (isDirectorySync(DEFAULT_AMP_DIR)) return DEFAULT_AMP_DIR;
	return null;
}
/**
* Find cache token information from messages for a specific messageId range
*/
function findCacheTokensForEvent(messages$1, fromMessageId, toMessageId) {
	if (messages$1 == null || toMessageId == null) return {
		cacheCreationInputTokens: 0,
		cacheReadInputTokens: 0
	};
	const message = messages$1.find((m$1) => m$1.role === "assistant" && m$1.messageId === toMessageId);
	if (message?.usage == null) return {
		cacheCreationInputTokens: 0,
		cacheReadInputTokens: 0
	};
	return {
...
*/
function convertLedgerEventToUsageEvent(threadId, event, messages$1) {
	const inputTokens = event.tokens.input ?? 0;
	const outputTokens = event.tokens.output ?? 0;
	const { cacheCreationInputTokens, cacheReadInputTokens } = findCacheTokensForEvent(messages$1, event.fromMessageId, event.toMessageId);
	return {
...
*/
async function loadThreadFile(filePath) {
	const readResult = await try_({
		try: readFile(filePath, "utf-8"),
		catch: (error) => error
	});
	if (isFailure(readResult)) {
		logger.debug("Failed to read Amp thread file", {
			filePath,
			error: readResult.error
		});
		return null;
	}
	const parseResult = try_({
		try: () => JSON.parse(readResult.value),
		catch: (error) => error
	})();
	if (isFailure(parseResult)) {
		logger.debug("Failed to parse Amp thread JSON", {
			filePath,
			error: parseResult.error
		});
		return null;
	}
	const validationResult = safeParse(threadSchema, parseResult.value);
...
*/
async function loadAmpUsageEvents(options = {}) {
	const ampPath = getAmpPath();
	const providedDirs = options.threadDirs != null && options.threadDirs.length > 0 ? options.threadDirs.map((dir) => path.resolve(dir)) : void 0;
...
if (import.meta.vitest != null) describe("loadAmpUsageEvents", () => {
	it("parses Amp thread files and extracts usage events", async () => {
		try {
			...
			const { events, threads, missingDirectories } = await loadAmpUsageEvents({ threadDirs: [_usingCtx$1.a(await k({ threads: { "T-test-thread-123.json": JSON.stringify(threadData) } })).getPath("threads")] });
	...
	it("handles malformed JSON gracefully", async () => {
		try {
			...
			const { events } = await loadAmpUsageEvents({ threadDirs: [_usingCtx3.a(await k({ threads: { "invalid.json": "not valid json" } })).getPath("threads")] });
			expect(events).toEqual([]);
		} catch (_$1) {
			_usingCtx3.e = _$1;
		} finally {
...
//#endregion
//#region ../../packages/internal/src/pricing.ts
...
if (import.meta.vitest != null) describe("LiteLLMPricingFetcher", () => {
	it("returns pricing data from LiteLLM dataset", async () => {
		try {
			var _usingCtx$1 = _usingCtx();
			const fetcher = _usingCtx$1.u(new LiteLLMPricingFetcher({
				offline: true,
				offlineLoader: async () => ({ "gpt-5": {
					input_cost_per_token: 125e-8,
					output_cost_per_token: 1e-5,
					cache_read_input_token_cost: 125e-9
				} })
			}));
			const pricing = await unwrap(fetcher.fetchModelPricing());
	...
	it("calculates cost using pricing information", async () => {
		try {
			var _usingCtx3 = _usingCtx();
			const fetcher = _usingCtx3.u(new LiteLLMPricingFetcher({
				offline: true,
				offlineLoader: async () => ({ "gpt-5": {
					input_cost_per_token: 125e-8,
					output_cost_per_token: 1e-5,
			...
			const cost = await unwrap(fetcher.calculateCostFromTokens({
				input_tokens: 1e3,
				output_tokens: 500,
				cache_read_input_tokens: 200
			}, "gpt-5"));
			expect(cost).toBeCloseTo(.006275);
		} catch (_$1) {
			_usingCtx3.e = _$1;
		} finally {
			_usingCtx3.d();
	...
	it("calculates tiered pricing for tokens exceeding 200k threshold (300k input, 250k output, 300k cache creation, 250k cache read)", async () => {
		try {
			...
			const fetcher = _usingCtx4.u(new LiteLLMPricingFetcher({
				offline: true,
				offlineLoader: async () => ({ "anthropic/claude-4-sonnet-20250514": {
			...
			const cost = await unwrap(fetcher.calculateCostFromTokens({
				input_tokens: 3e5,
				output_tokens: 25e4,
				cache_creation_input_tokens: 3e5,
				cache_read_input_tokens: 25e4
			}, "anthropic/claude-4-sonnet-20250514"));
			expect(cost).toBeCloseTo(6.915);
		} catch (_$1) {
			_usingCtx4.e = _$1;
		} finally {
			_usingCtx4.d();
	...
	it("uses standard pricing for 300k/250k tokens when model lacks tiered pricing", async () => {
		try {
			...
			const fetcher = _usingCtx5.u(new LiteLLMPricingFetcher({
				offline: true,
				offlineLoader: async () => ({ "gpt-5": {
	...
	it("correctly applies pricing at 200k boundary (200k uses base, 200,001 uses tiered, 0 returns 0)", async () => {
		try {
			...
			const fetcher = _usingCtx6.u(new LiteLLMPricingFetcher({
				offline: true,
				offlineLoader: async () => ({ "claude-4-sonnet-20250514": {
					input_cost_per_token: 3e-6,
					input_cost_per_token_above_200k_tokens: 6e-6
				} })
			}));
			const cost200k = await unwrap(fetcher.calculateCostFromTokens({
				input_tokens: 2e5,
				output_tokens: 0
			}, "claude-4-sonnet-20250514"));
			expect(cost200k).toBeCloseTo(2e5 * 3e-6);
			const cost200k1 = await unwrap(fetcher.calculateCostFromTokens({
				input_tokens: 200001,
				output_tokens: 0
			}, "claude-4-sonnet-20250514"));
			expect(cost200k1).toBeCloseTo(.6000059999999999);
			const costZero = await unwrap(fetcher.calculateCostFromTokens({
				input_tokens: 0,
				output_tokens: 0
			}, "claude-4-sonnet-20250514"));
	...
	it("charges only for tokens above 200k when base price is missing (300k→100k charged, 100k→0 charged)", async () => {
		try {
			...
			const fetcher = _usingCtx7.u(new LiteLLMPricingFetcher({
				offline: true,
				offlineLoader: async () => ({ "theoretical-model": {
					input_cost_per_token_above_200k_tokens: 6e-6,
					output_cost_per_token_above_200k_tokens: 225e-7
				} })
			}));
			...
			expect(cost).toBeCloseTo(1.725);
			const costBelow = await unwrap(fetcher.calculateCostFromTokens({
				input_tokens: 1e5,
				output_tokens: 1e5
			}, "theoretical-model"));
...
//#endregion
//#region ../../packages/internal/src/pricing-fetch-utils.ts
...
//#endregion
//#region src/_macro.ts
const AMP_MODEL_PREFIXES = ["claude-", "anthropic/"];
function isAmpModel(modelName, _pricing) {
	return AMP_MODEL_PREFIXES.some((prefix) => modelName.startsWith(prefix));
}
async function prefetchAmpPricing() {
	try {
		return filterPricingDataset(await fetchLiteLLMPricingDataset(), isAmpModel);
	} catch (error) {
...
var AmpPricingSource = class {
	...
	async calculateCost(model, tokens) {
...
if (import.meta.vitest != null) describe("AmpPricingSource", () => {
	it("converts LiteLLM pricing to per-million costs", async () => {
		try {
			var _usingCtx$1 = _usingCtx();
			const pricing = await _usingCtx$1.u(new AmpPricingSource({
				offline: true,
				offlineLoader: async () => ({ "claude-haiku-4-5-20251001": {
					input_cost_per_token: 1e-6,
					output_cost_per_token: 5e-6,
					cache_read_input_token_cost: 1e-7,
					cache_creation_input_token_cost: 125e-8
				} })
			})).getPricing("claude-haiku-4-5-20251001");
			expect(pricing.inputCostPerMToken).toBeCloseTo(1);
			expect(pricing.outputCostPerMToken).toBeCloseTo(5);
			expect(pricing.cachedInputCostPerMToken).toBeCloseTo(.1);
	...
	it("calculates cost from tokens", async () => {
		try {
			var _usingCtx3 = _usingCtx();
			const cost = await _usingCtx3.u(new AmpPricingSource({
				offline: true,
				offlineLoader: async () => ({ "claude-haiku-4-5-20251001": {
					input_cost_per_token: 1e-6,
					output_cost_per_token: 5e-6,
			...
			})).calculateCost("claude-haiku-4-5-20251001", {
				inputTokens: 1e3,
				outputTokens: 500,
				cacheReadInputTokens: 200,
				cacheCreationInputTokens: 100
			});
			expect(cost).toBeCloseTo(.0036450000000000002);
		} catch (_$1) {
			_usingCtx3.e = _$1;
		} finally {
			_usingCtx3.d();
...
const TABLE_COLUMN_COUNT$2 = 9;
function groupByDate(events) {
	const grouped = /* @__PURE__ */ new Map();
	for (const event of events) {
		const date = event.timestamp.split("T")[0];
		const existing = grouped.get(date);
		if (existing != null) existing.push(event);
...
const dailyCommand = define({
	...
	async run(ctx) {
		try {
			...
			if (events.length === 0) {
				const output = jsonOutput ? JSON.stringify({
					daily: [],
					totals: null
			...
			const pricingSource = _usingCtx$1.u(new AmpPricingSource({ offline: false }));
			...
			dailyData.sort((a$2, b$2) => a$2.date.localeCompare(b$2.date));
			const totals = {
				inputTokens: dailyData.reduce((sum, d$1) => sum + d$1.inputTokens, 0),
				outputTokens: dailyData.reduce((sum, d$1) => sum + d$1.outputTokens, 0),
				cacheCreationTokens: dailyData.reduce((sum, d$1) => sum + d$1.cacheCreationTokens, 0),
				cacheReadTokens: dailyData.reduce((sum, d$1) => sum + d$1.cacheReadTokens, 0),
				totalTokens: dailyData.reduce((sum, d$1) => sum + d$1.totalTokens, 0),
				credits: dailyData.reduce((sum, d$1) => sum + d$1.credits, 0),
				totalCost: dailyData.reduce((sum, d$1) => sum + d$1.totalCost, 0)
			};
			if (jsonOutput) {
			...
			table.push([
				...
				import_picocolors$2.default.yellow(formatNumber(totals.totalTokens)),
				import_picocolors$2.default.yellow(totals.credits.toFixed(2)),
...
const monthlyCommand = define({
	...
	async run(ctx) {
		try {
			...
			monthlyData.sort((a$2, b$2) => a$2.month.localeCompare(b$2.month));
			const totals = {
				inputTokens: monthlyData.reduce((sum, d$1) => sum + d$1.inputTokens, 0),
				outputTokens: monthlyData.reduce((sum, d$1) => sum + d$1.outputTokens, 0),
				cacheCreationTokens: monthlyData.reduce((sum, d$1) => sum + d$1.cacheCreationTokens, 0),
				cacheReadTokens: monthlyData.reduce((sum, d$1) => sum + d$1.cacheReadTokens, 0),
				totalTokens: monthlyData.reduce((sum, d$1) => sum + d$1.totalTokens, 0),
				credits: monthlyData.reduce((sum, d$1) => sum + d$1.credits, 0),
				totalCost: monthlyData.reduce((sum, d$1) => sum + d$1.totalCost, 0)
			};
			if (jsonOutput) {
				console.log(JSON.stringify({
					monthly: monthlyData,
			...
			table.push([
				...
				import_picocolors$1.default.yellow(formatNumber(totals.totalTokens)),
				import_picocolors$1.default.yellow(totals.credits.toFixed(2)),
...
const sessionCommand = define({
	...
	async run(ctx) {
		try {
			...
			sessionData.sort((a$2, b$2) => a$2.lastActivity.localeCompare(b$2.lastActivity));
			const totals = {
				inputTokens: sessionData.reduce((sum, s$1) => sum + s$1.inputTokens, 0),
				outputTokens: sessionData.reduce((sum, s$1) => sum + s$1.outputTokens, 0),
				cacheCreationTokens: sessionData.reduce((sum, s$1) => sum + s$1.cacheCreationTokens, 0),
				cacheReadTokens: sessionData.reduce((sum, s$1) => sum + s$1.cacheReadTokens, 0),
				totalTokens: sessionData.reduce((sum, s$1) => sum + s$1.totalTokens, 0),
				credits: sessionData.reduce((sum, s$1) => sum + s$1.credits, 0),
				totalCost: sessionData.reduce((sum, s$1) => sum + s$1.totalCost, 0)
			};
			if (jsonOutput) {
				console.log(JSON.stringify({
			...
			table.push([
				...
				import_picocolors.default.yellow(formatNumber(totals.totalTokens)),
				import_picocolors.default.yellow(totals.credits.toFixed(2)),
...
async function run() {
	...
	if (args[0] === "ccusage-amp") args = args.slice(1);
